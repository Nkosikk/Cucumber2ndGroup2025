...
public class stepDef extends Base {
    ...
    public void i_click_on_under_categories(String argO) {
        homePage.clickLaptopsCategory(argO);
    }
    ...
    public void i_should_see_a_popup_message(String accept) {
        cartPage.assertTextIsDisplayedAndAccept(accept);
    }
    ...
    public void i_should_see_the_place_order_form_displayed() {
        placeOrderPage.verifyPlaceOrderPageIsDisplayed();

    }

    @Then("I click on Purchase without entering any data")
    public void i_click_on_purchase_without_entering_any_data() {
        placeOrderPage.clickPurchaseButtonWithoutEnteringData();
    }

    @Then("I should see an error alert displayed with the message {string}")
    public void i_should_see_an_error_alert_displayed_with_the_message(String arg0) {
